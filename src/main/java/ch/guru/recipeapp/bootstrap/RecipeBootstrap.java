package ch.guru.recipeapp.bootstrap;

import ch.guru.recipeapp.domain.*;
import ch.guru.recipeapp.repositories.CategoryRepository;
...
@Slf4j
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> { //like commandLineRunner
